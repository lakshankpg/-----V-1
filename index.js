...
async function connectToWA() {
  ...
  console.log("Connecting DARK KING -XMD");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("DARK KING -XMD installed successful ✅");
      console.log("DARK KING -XMD connected to whatsapp ✅");

      let up = `DARK KING -XMD connected successful ✅`;
      let up1 = `Hello DARK KING -XMD, I made bot successful`;
...
app.get("/", (req, res) => {
  res.send("hey, DARK KING -XMD started✅");
});
app.listen(port, () =>
